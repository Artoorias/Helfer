...
final class config {
    ...
    final static public String zawartosc_w = "Pij wode";
    final static public String zawartosc_k = "pamiętaj o kanapce na jutro";
    final static public String ticker_k = "HELFER";
    final static public String ticker_w = "HELFER";
}
